...
function (s) {
  ...
  s.fn.button = i,
    ...
    s(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function (t) {
      ...
      i.call(e, "toggle"),
        s(t.target).is('input[type="radio"]') || s(t.target).is('input[type="checkbox"]') || (t.preventDefault(),
...
function (l) {
  ...
  var h = function (t, e) {
    ...
    this.options = e,
      ...
      this.options.remote && o.find(".modal-content").load(this.options.remote, l.proxy(function () {
        this.$element.trigger("loaded.bs.modal")
      }, this)),
      i = this.options.page,
      !/#/.test(i) && i && (o.find(".modal-content").append('<iframe src="' + i + '" class="modal-iframe"></iframe>'),
  ...
  function s(a, r) {
    return this.each(function () {
      ...
      n || (o.data("bs.modal", n = new h(this, s)),
  ...
  h.VERSION = "3.3.6",
      ...
      this.$element.trigger(e),
        this.isShown || e.isDefaultPrevented() || (this.isShown = !0,
          ...
          this.backdrop(function () {
            ...
            if (s.$element.parent().length || s.$element.appendTo(s.$body),
              s.flag) {
              var e = s.$element.attr("id");
              s.$element.after('<div id="' + e + '-admui"></div>'),
                s.$element.appendTo(s.$body).show().scrollTop(0)
            } else
              s.$element.show().scrollTop(0);
            a ? s.$element.find("iframe").one("load", function () {
                var t = l(this).prop("contentWindow").document;
                l(t).on("click.dismiss.bs.modal", '[data-dismiss="modal"]', l.proxy(s.hide, s))
              }) : s.$element.on("click.dismiss.bs.modal", '[data-dismiss="modal"]', l.proxy(s.hide, s)),
              s.adjustDialog(),
              t && s.$element[0].offsetWidth,
              s.$element.addClass("in"),
              s.enforceFocus();
            var i = l.Event("shown.bs.modal", {
                relatedTarget: n
              }),
              o = function () {
            ...
            t ? a ? o() : s.$dialog.one("bsTransitionEnd", function () {
              s.$element.trigger("focus").trigger(i)
            }).emulateTransitionEnd(h.TRANSITION_DURATION) : a ? o() : s.$element.trigger("focus").trigger(i)
          }))
    },
    h.prototype.hide = function (t) {
      t && t.preventDefault(),
        ...
        this.isShown && !t.isDefaultPrevented() && (this.isShown = !1,
          ...
          l.support.transition && this.$element.hasClass("fade") ? this.$element.one("bsTransitionEnd", l.proxy(this.hideModal, this)).emulateTransitionEnd(h.TRANSITION_DURATION) : this.hideModal())
    },
    h.prototype.enforceFocus = function () {
      var e = this._document;
      l(e).off("focusin.bs.modal").on("focusin.bs.modal", l.proxy(function (t) {
        e === t.target || this.$element[0] === t.target || this.$element.has(t.target).length || this.$element.trigger("focus")
      }, this))
    },
    h.prototype.escape = function () {
      this.isShown && this.options.keyboard ? this.$element.on("keydown.dismiss.bs.modal", l.proxy(function (t) {
        27 == t.which && this.hide()
      }, this)) : this.isShown || this.$element.off("keydown.dismiss.bs.modal")
    },
    h.prototype.resize = function () {
      var t = this.global;
      this.isShown ? l(t).on("resize.bs.modal", l.proxy(this.handleUpdate, this)) : l(t).off("resize.bs.modal")
    },
    h.prototype.iframeAuto = function () {
      var t, e = this.options.page;
      !/#/.test(e) && e && this.isShown && (t = this.$element.find("iframe")).css({
        height: t.contents().find("html").outerHeight()
      })
    },
    h.prototype.hideModal = function () {
      var t = this,
        e = t.$element.attr("id");
      t.$element.hide(),
        t.flag && l("#" + e + "-admui").before(t.$element).remove(),
        this.backdrop(function () {
    ...
    h.prototype.backdrop = function (t) {
      ...
      if (this.isShown && this.options.backdrop) {
        ...
        if (this.$backdrop = l(e._document.createElement("div")).addClass("modal-backdrop " + i).appendTo(this.$body),
          this.$element.on("click.dismiss.bs.modal", l.proxy(function (t) {
        ...
        l.support.transition && this.$element.hasClass("fade") ? this.$backdrop.one("bsTransitionEnd", n) : n()
      } else
        t && t()
    },
  ...
  l.fn.modal = s,
    ...
    l(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function (t) {
      var e = l(this),
        ...
        n = o.data("bs.modal") ? "toggle" : l.extend({
          remote: !/#/.test(i) && i
        }, o.data(), e.data());
