!function (l, e) {
  ...
  var c, d, t, i, n = l.layui && layui.define,
    u = {
      getPath: (t = document.currentScript ? document.currentScript.src : function () {
      ...
      getStyle: function (e, t) {
        var i = e.currentStyle ? e.currentStyle : l.getComputedStyle(e, null);
    ...
    y = {
      v: "3.1.1",
      ie: (i = navigator.userAgent.toLowerCase(),
        !!(l.ActiveXObject || "ActiveXObject" in l) && ((i.match(/msie\s(\d+)/) || [])[1] || "11")),
      index: l.layer && l.layer.v ? 1e5 : 0,
      path: u.getPath,
      config: function (e, t) {
        return e = e || {},
      ...
      ready: function (e) {
        ...
        return n ? layui.addcss(i, e, t) : u.link(i, e, t),
          this
      },
      ...
      msg: function (e, t, i) {
        ...
        return n && (i = t),
          y.open(c.extend({
            ...
            anim: s
          } : ((-1 === (t = t || {}).icon || void 0 === t.icon && !u.config.skin) && (t.skin = o + " " + (t.skin || "layui-layer-hui")),
            t)))
      },
      load: function (e, t) {
        return y.open(c.extend({
          type: 3,
          icon: e || 0,
          resize: !1,
          shade: .01
  ...
  p.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"],
    a.pt.config = {
      type: 0,
      shade: .3,
      fixed: !0,
    ...
    a.pt.vessel = function (e, t) {
      var i, n = this.index,
        ...
        l = a.title ? '<div class="layui-layer-title" style="' + (s ? a.title[1] : "") + '">' + (s ? a.title[0] : a.title) + "</div>" : "";
      return a.zIndex = o,
        t([a.shade ? '<div class="layui-layer-shade" id="layui-layer-shade' + n + '" times="' + n + '" style="z-index:' + (o - 1) + '; "></div>' : "", '<div class="' + p[0] + " layui-layer-" + u.type[a.type] + (0 != a.type && 2 != a.type || a.shade ? "" : " layui-layer-border") + " " + (a.skin || "") + '" id="' + p[0] + n + '" type="' + u.type[a.type] + '" times="' + n + '" showtime="' + a.time + '" conType="' + (e ? "object" : "string") + '" style="z-index: ' + o + "; width:" + a.area[0] + ";height:" + a.area[1] + (a.fixed ? "" : ";position:absolute;") + '">' + (e && 2 != a.type ? "" : l) + '<div id="' + (a.id || "") + '" class="layui-layer-content' + (0 == a.type && -1 !== a.icon ? " layui-layer-padding" : "") + (3 == a.type ? " layui-layer-loading" + a.icon : "") + '">' + (0 == a.type && -1 !== a.icon ? '<i class="layui-layer-ico layui-layer-ico' + a.icon + '"></i>' : "") + (1 == a.type && e ? "" : a.content || "") + '</div><span class="layui-layer-setwin">' + (i = r ? '<a class="layui-layer-min" href="javascript:;"><cite></cite></a><a class="layui-layer-ico layui-layer-max" href="javascript:;"></a>' : "",
          a.closeBtn && (i += '<a class="layui-layer-ico ' + p[7] + " " + p[7] + (a.title ? a.closeBtn : 4 == a.type ? "1" : "2") + '" href="javascript:;"></a>'),
          i) + "</span>" + (a.btn ? function () {
          var e = "";
          "string" == typeof a.btn && (a.btn = [a.btn]);
          for (var t = 0, i = a.btn.length; t < i; t++)
            e += '<a class="' + p[6] + t + '">' + a.btn[t] + "</a>";
          return '<div class="' + p[6] + " layui-layer-btn-" + (a.btnAlign || "") + '">' + e + "</div>"
        }() : "") + (a.resize ? '<span class="layui-layer-resize"></span>' : "") + "</div>"], l, c('<div class="layui-layer-move"></div>')),
        this
    },
    a.pt.creat = function () {
      var n = this,
      ...
      if (!a.id || !c("#" + a.id)[0]) {
        switch ("string" == typeof a.area && (a.area = "auto" === a.area ? ["", ""] : [a.area, ""]),
          ...
          case 2:
            ...
            a.content = '<iframe scrolling="' + (a.content[1] || "auto") + '" allowtransparency="true" id="' + p[4] + o + '" name="' + p[4] + o + '" onload="this.className=\'\';" class="layui-layer-load" frameborder="0" src="' + a.content[0] + '"></iframe>';
            break;
          case 3:
            delete a.title,
              delete a.closeBtn,
        ...
        if (n.vessel(s, function (e, t, i) {
            r.append(e[0]),
              s ? 2 == a.type || 4 == a.type ? c("body").append(e[1]) : l.parents("." + p[0])[0] || ("object" == typeof l && (f = l.context,
                  l.after('<div id="admui-' + p[0] + n.index + '"></div>')),
                c("body").append(l.data("display", l.css("display")).show().addClass("layui-layer-wrap").wrap(e[1]).parents("#" + p[0] + n.index)),
                c("#" + p[0] + o).find("." + p[5]).before(t)) : r.append(e[1]),
              c(".layui-layer-move")[0] || r.append(u.moveElem = i),
              n.layero = c("#" + p[0] + o),
          ...
          2 == a.type && 6 == y.ie && n.layero.find("iframe").attr("src", l[0]),
          4 == a.type ? n.tips() : n.offset(),
          a.fixed && d.on("resize", function () {
            n.offset(),
    ...
    a.pt.auto = function (e) {
      var t = this.config,
        i = c("#" + p[0] + e);
      "" === t.area[0] && 0 < t.maxWidth && (y.ie && y.ie < 8 && t.btn && i.width(i.innerWidth()),
      ...
      switch (t.type) {
        ...
        default:
          "" === t.area[1] ? 0 < t.maxHeight && i.outerHeight() > t.maxHeight ? (n[1] = t.maxHeight,
            s("." + p[5])) : t.fixed && n[1] >= d.height() && (n[1] = d.height(),
            s("." + p[5])) : s("." + p[5])
      }
      return this
    },
    a.pt.offset = function () {
      ...
      e.offsetTop = (d.height() - n[1]) / 2,
        ...
        i.attr("minLeft") && (e.offsetTop = d.height() - (i.find(p[1]).outerHeight() || 0),
          e.offsetLeft = i.css("left")),
        i.attr("myTopLeft") && (e.offsetTop = i.css("top"),
          e.offsetLeft = i.css("left")),
        i.css({
          top: e.offsetTop,
          left: e.offsetLeft
    ...
    a.pt.tips = function () {
      ...
      e.tips[1] || o.remove(),
        ...
        a.where[s - 1](),
        1 === s ? a.top - (d.scrollTop() + i[1] + 16) < 0 && a.where[2]() : 2 === s ? 0 < d.width() - (a.left + a.width + i[0] + 16) || a.where[3]() : 3 === s ? 0 < a.top - d.scrollTop() + a.height + i[1] + 16 - d.height() && a.where[0]() : 4 === s && 0 < i[0] + 16 - a.left && a.where[1](),
        t.find("." + p[5]).css({
    ...
    a.pt.move = function () {
      var s = this,
        ...
        f = {};
      return r.move && t.css("cursor", "move"),
        t.on("mousedown", function (e) {
          e.preventDefault(),
            r.move && (f.moveStart = !0,
              f.offset = [e.clientX - parseFloat(l.css("left")), e.clientY - parseFloat(l.css("top"))],
        ...
        e.on("mousemove", function (e) {
          if (f.moveStart) {
            ...
            if (e.preventDefault(),
              ...
              !r.moveOut) {
              var a = d.width() - l.outerWidth() + f.stX,
                o = d.height() - l.outerHeight() + f.stY;
              t < f.stX && (t = f.stX),
                a < t && (t = a),
                i < f.stY && (i = f.stY),
                o < i && (i = o)
          ...
          if (r.resize && f.resizeStart) {
            t = e.clientX - f.offset[0],
              i = e.clientY - f.offset[1];
            e.preventDefault(),
              y.style(s.index, {
                width: f.area[0] + t,
              ...
              f.isResize = !0,
              r.resizing && r.resizing(l)
          }
        }).on("mouseup", function (e) {
          f.moveStart && (delete f.moveStart,
              u.moveElem.hide(),
              r.moveEnd && r.moveEnd(l)),
            f.resizeStart && (delete f.resizeStart,
              u.moveElem.hide())
        }),
        s
    },
    a.pt.callback = function () {
      ...
      t.openLayer(),
        ...
        6 == y.ie && t.IE6(i),
        i.find("." + p[6]).children("a").on("click", function () {
          var e = c(this).index();
          0 === e ? n.yes ? n.yes(t.index, i) : n.btn1 ? n.btn1(t.index, i) : y.close(t.index) : !1 === (n["btn" + (e + 1)] && n["btn" + (e + 1)](t.index, i)) || y.close(t.index)
        }),
        i.find("." + p[7]).on("click", function () {
          !1 === (n.cancel && n.cancel(t.index, i)) || y.close(t.index)
        }),
        n.shadeClose && c("#layui-layer-shade" + t.index).on("click", function () {
          y.close(t.index)
        }),
        ...
        i.find(".layui-layer-max").on("click", function () {
          c(this).hasClass("layui-layer-maxmin") ? (y.restore(t.index),
            n.restore && n.restore(i)) : (y.full(t.index, n),
            setTimeout(function () {
              n.full && n.full(i)
            }, 100))
        }),
    ...
    u.reselect = function () {
      c.each(c("select"), function (e, t) {
        var i = c(this);
        i.parents("." + p[0])[0] || 1 == i.attr("layer") && c("." + p[0]).length < 1 && i.removeAttr("layer").show(),
          i = null
      })
    },
    a.pt.IE6 = function (e) {
      c("select").each(function (e, t) {
        var i = c(this);
        i.parents("." + p[0])[0] || "none" === i.css("display") || i.attr({
            layer: "1"
          }).hide(),
          i = null
      })
    ...
    a.pt.openLayer = function () {
      y.zIndex = this.config.zIndex,
        y.setTop = function (e) {
          return y.zIndex = parseInt(e[0].style.zIndex),
            e.on("mousedown", function () {
              y.zIndex++,
                e.css("z-index", y.zIndex + 1)
            }),
            y.zIndex
        }
    },
    ...
    u.rescollbar = function (e) {
      p.html.attr("layer-full") == e && (p.html[0].style.removeProperty ? p.html[0].style.removeProperty("overflow") : p.html[0].style.removeAttribute("overflow"),
        p.html.removeAttr("layer-full"))
    },
    (l.layer = y).getChildFrame = function (e, t) {
      return t = t || c("." + p[4]).attr("times"),
        c("#" + p[0] + t).find("iframe").contents().find(e)
    },
    y.getFrameIndex = function (e) {
      return c("#" + e).parents("." + p[4]).attr("times")
    },
    ...
    y.iframeSrc = function (e, t) {
      c("#" + p[0] + e).find("iframe").attr("src", t)
    },
    y.style = function (e, t, i) {
      var n = c("#" + p[0] + e),
        ...
        r = n.find("." + p[6]).outerHeight() || 0;
      n.attr("minLeft");
      o !== u.type[3] && o !== u.type[4] && (i || (parseFloat(t.width) <= 260 && (t.width = 260),
          parseFloat(t.height) - s - r <= 64 && (t.height = 64 + s + r)),
        n.css(t),
        r = n.find("." + p[6]).outerHeight(),
        o === u.type[2] ? n.find("iframe").css({
          height: parseFloat(t.height) - s - r
        }) : a.css({
          height: parseFloat(t.height) - s - r - parseFloat(a.css("padding-top")) - parseFloat(a.css("padding-bottom"))
        }))
    },
    y.min = function (e, t) {
      var i = c("#" + p[0] + e),
    ...
    y.title = function (e, t) {
      c("#" + p[0] + (t || y.index)).find(p[1]).html(e)
    },
    y.close = function (n) {
      var a = c("#" + p[0] + n),
        o = a.attr("type");
      if (a[0]) {
          ...
          e = function () {
            if (o === u.type[1] && "object" === a.attr("conType")) {
              ...
              for (var e = a.find("." + s), t = 0; t < 2; t++)
                e.unwrap();
              f ? c(f).find("#admui-" + p[0] + n).before(e.css("display", e.data("display")).removeClass(s)) : e.css("display", e.data("display")).removeClass(s),
        ...
        a.data("isOutAnim") && a.addClass("layer-anim layer-anim-close"),
          ...
          y.ie && y.ie < 10 || !a.data("isOutAnim") ? e() : setTimeout(function () {
            e()
          }, 200)
      }
    },
  ...
  y.prompt = function (i, n) {
      ...
      var a, o = 2 == i.formType ? '<textarea class="layui-layer-input"' + e + ">" + (i.value || "") + "</textarea>" : '<input type="' + (1 == i.formType ? "password" : "text") + '" class="layui-layer-input" value="' + (i.value || "") + '">',
        s = i.success;
      return delete i.success,
        y.open(c.extend({
          ...
          yes: function (e) {
            var t = a.val();
            "" === t ? a.focus() : t.length > (i.maxlength || 500) ? y.tips("&#x6700;&#x591A;&#x8F93;&#x5165;" + (i.maxlength || 500) + "&#x4E2A;&#x5B57;&#x6570;", a, {
              tips: 1
            }) : n && n(t, e, a)
          }
        }, i))
        ...
        y.open(c.extend({
          ...
          content: '<ul class="layui-layer-tabmain">' + function () {
            var e = n.length,
              ...
              i = "";
            if (0 < e)
              for (i = '<li class="layui-layer-tabli ' + o + '">' + (n[0].content || "no content") + "</li>"; t < e; t++)
    ...
    y.photos = function (a, e, t) {
      ...
      if ((a = a || {}).photos) {
        ...
        i.imgprev = function (e) {
            i.imgIndex--,
              i.imgIndex < 1 && (i.imgIndex = o.length),
              i.tabimg(e)
          },
          i.imgnext = function (e, t) {
            i.imgIndex++,
              i.imgIndex > o.length && (i.imgIndex = 1,
                t) || i.tabimg(e)
          },
          i.keyup = function (e) {
            if (!i.end) {
          ...
          function (e, t, i) {
            ...
            y.close(i.loadi),
              i.index = y.open(c.extend({
                type: 1,
                id: "layui-layer-photos",
                area: function () {
                  var e = [n.width, n.height],
                    t = [c(l).width() - 100, c(l).height() - 100];
                ...
                content: '<div class="layui-layer-phimg"><img src="' + o[s].src + '" alt="' + (o[s].alt || "") + '" layer-pid="' + o[s].pid + '"><div class="layui-layer-imgsee">' + (1 < o.length ? '<span class="layui-layer-imguide"><a href="javascript:;" class="layui-layer-iconext layui-layer-imgprev"></a><a href="javascript:;" class="layui-layer-iconext layui-layer-imgnext"></a></span>' : "") + '<div class="layui-layer-imgbar" style="display:' + (t ? "block" : "") + '"><span class="layui-layer-imgtit"><a href="javascript:;">' + (o[s].alt || "") + "</a><em>" + i.imgIndex + "/" + o.length + "</em></span></div></div></div>",
    ...
    l.layui && layui.define ? (y.ready(),
      layui.define("jquery", function (e) {
        y.path = layui.cache.dir,
          u.run(layui.$),
          e("layer", l.layer = y)
      })) : "function" == typeof define && define.amd ? define(["jquery"], function () {
      return u.run(l.jQuery),
        y
    }) : (u.run(l.jQuery),
      y.ready())
}(window);
